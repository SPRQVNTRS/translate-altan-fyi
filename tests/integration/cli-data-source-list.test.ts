/**
 * Integration test: `cli data-source list --org=default`
 *
...
describe('cli data-source list', () => {
  it('lists data sources and returns data field', { skip: !TEST_API_KEY ? 'TEST_API_KEY not set' : false }, () => {
    const result = spawnSync(
      'node_modules/.bin/tsx',
      ['cli/index.ts', '--remote', REMOTE_URL, 'data-source', 'list', '--org=default', '--format=json'],
      {
        encoding: 'utf8',
