/**
 * Integration test: `cli workflow list --format=json`
 *
...
describe('cli workflow list', () => {
  it('lists workflows and returns data field', { skip: !TEST_API_KEY ? 'TEST_API_KEY not set' : false }, () => {
    const result = spawnSync(
      'node_modules/.bin/tsx',
      ['cli/index.ts', '--remote', REMOTE_URL, 'workflow', 'list', '--format=json'],
      {
        encoding: 'utf8',
