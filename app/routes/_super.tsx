...
import { authMiddleware, superadminMiddleware } from '#app/middleware/auth';
 ...
 * read by a screen.
 *
 * TWO MIDDLEWARES, IN THIS ORDER. `authMiddleware` resolves the session and
 ...
 *
 * IT IS `authMiddleware`, NOT `authMiddleware`. This layout nested under
 ...
 */
export const middleware = [authMiddleware, superadminMiddleware];
