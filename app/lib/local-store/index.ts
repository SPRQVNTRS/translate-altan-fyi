...
export type { SyncStamp, LocalList, LocalListItem, LocalNote, LocalHistoryEntry, LocalStoreSnapshot } from './schema';
...
export type { LocalListInput, LocalListItemInput, LocalNoteInput } from './primary-store';
