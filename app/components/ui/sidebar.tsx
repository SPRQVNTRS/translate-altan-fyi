    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          style={
            // SAFETY: CSSProperties does not admit custom properties, but
            // the DOM accepts any `--*` key on an inline style object.
            {
  ...
  return (
    ...
    >
      ...
      <Skeleton
        ...
        style={
          // SAFETY: CSSProperties does not admit custom properties, but the
          // DOM accepts any `--*` key on an inline style object.
          {
